      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-white/10 pb-8 mb-3">
          ...
          <div className="flex items-center space-x-8">
            {/* LinkedIn */}
            <a
              href={`${CONSTANTS.linkedin.url}`}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center space-x-3 hover:text-[#FF8A8A] transition-colors"
            >
              ...
              <span className="text-sm opacity-70 group-hover:opacity-100 transition-opacity">LinkedIn</span>
            </a>
