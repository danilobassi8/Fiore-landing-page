            ...
            <div className="space-y-10">
              <div className="flex items-start space-x-6">
                <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                  <svg className="w-4 h-4 text-[#FF8A8A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              <div className="flex items-start space-x-6">
                <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                  <svg className="w-4 h-4 text-[#FF8A8A]" fill="currentColor" viewBox="0 0 24 24">
